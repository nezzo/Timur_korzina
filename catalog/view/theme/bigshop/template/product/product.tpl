    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div itemscope itemtype="http://schema.org/Product">
        ...
        <div class="row product-info">
          ...
          <?php if ($thumb || $images) { ?>
          <?php if($config->get('bigshop_cloud_zoom')== 1) { ?>
          <div class="<?php echo $class; ?>">
            <script src="catalog/view/theme/bigshop/js/jquery.elevateZoom-3.0.8.min.js"></script>
            <script src="catalog/view/javascript/jquery/swipebox/lib/ios-orientationchange-fix.js"></script>
            <script src="catalog/view/javascript/jquery/swipebox/js/jquery.swipebox.js"></script>
            <link rel="stylesheet" href="catalog/view/javascript/jquery/swipebox/css/swipebox.min.css">
            <link rel="stylesheet" href="catalog/view/theme/bigshop/stylesheet/resp-module.css">
            <?php if ($thumb) { ?>
            ...
            <?php } ?>
            <?php if($config->get('bigshop_cloud_zoom_gallery')== 1) {
    $bigshop_cloud_zoom_gallery_text = $config->get('bigshop_cloud_zoom_gallery_text'); { ?>
            ...
            <?php } ?>
            <?php if($config->get('bigshop_cloud_zoom_inner')== 1) { ?>
...
$("#zoom_01").bind("click", function(e) {
  ...
  return false;
          ...
          <div class="<?php echo $class; ?>">
            ...
            <?php } ?>
            <?php if($config->get('bigshop_share_plugin')== 1) { ?>
            <hr>
            <!-- AddThis Button BEGIN -->
            <?php if($config->get('bigshop_share_plugin_style')== 1) { ?>
            <div class="addthis_toolbox addthis_default_style"> <a class="addthis_button_facebook_like" fb:like:layout="button_count"></a> <a class="addthis_button_tweet"></a> <a class="addthis_button_google_plusone" g:plusone:size="medium"></a> <a class="addthis_button_pinterest_pinit" pi:pinit:layout="horizontal" pi:pinit:url="http://www.addthis.com/features/pinterest" pi:pinit:media="http://www.addthis.com/cms-content/images/features/pinterest-lg.png"></a> <a class="addthis_counter addthis_pill_style"></a> </div>
            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-514863386b357649"></script>
            <?php } ?>
            <?php if($config->get('bigshop_share_plugin_style')== 2) { ?>
            ...
            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-514863386b357649"></script>
            <?php } ?>
            <?php if($config->get('bigshop_share_plugin_style')== 3) { ?>
        ...
        <?php global $config; if($config->get('bigshop_related_slider_product_style')== '1') { ?>
        <?php if ($products) { ?>
        ...
        <?php if($config->get('bigshop_related_slider_product_per_row')== '3') { ?>
<script type="text/javascript">
...
<?php } elseif ($config->get('bigshop_related_slider_product_per_row')== '4') {?>
<script type="text/javascript">
$(document).ready(function(){
...
<?php } elseif ($config->get('bigshop_related_slider_product_per_row')== '5') {?>
<script type="text/javascript">
$(document).ready(function(){
...
<?php } elseif ($config->get('bigshop_related_slider_product_per_row')== '6') {?>
<script type="text/javascript">
$(document).ready(function(){
...
<?php } ?>
	...
	$(document).ready(function() {
		...
		itemsCustom : [[320, 2],[600, 3],[768, 3],[992, <?php echo $config->get('bigshop_related_slider_product_per_row'); ?>],[1199, <?php echo $config->get('bigshop_related_slider_product_per_row'); ?>]],											   
		lazyLoad : true,
		navigation : true,
...
<?php if($config->get('bigshop_cloud_zoom')== 2) { ?>
$(document).ready(function() {
