...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <?php } ?>
      <?php global $config; if($config->get('bigshop_refine_categories')== 1) { ?>
      <?php if ($categories) { ?>
      <h3><?php echo $text_refine; ?></h3>
      <?php if($config->get('bigshop_refine_categories_images')== 1) { ?>
...
<?php global $config; if($config->get('bigshop_category_product_per_row')== 'pr3') { ?>
<script type="text/javascript">
$(document).ready(function(){
...
<?php } elseif ($config->get('bigshop_category_product_per_row')== 'pr4') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
<?php } elseif ($config->get('bigshop_category_product_per_row')== 'pr5') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
<?php } elseif ($config->get('bigshop_category_product_per_row')== 'pr6') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
